import { TestBed, async, waitForAsync, fakeAsync, tick } from '@angular/core/testing';
...
describe('Component: User', () => {
  ...
  it('shouldn\'t display the user name if is not logged in', () => {
    let fixture = TestBed.createComponent(UserComponent);
    let app = fixture.debugElement.componentInstance;
    let userService = fixture.debugElement.injector.get(UserService);
    fixture.detectChanges();
  ...
  it('should fetch data successfully if called asynchronously with fakeAsync', fakeAsync(() => {
    let fixture = TestBed.createComponent(UserComponent);
    let app = fixture.debugElement.componentInstance;
    let dataService = fixture.debugElement.injector.get(DataService);
    let spy = spyOn(dataService, 'getDetails')
